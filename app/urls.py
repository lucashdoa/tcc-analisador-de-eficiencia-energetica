...
urlpatterns = [
    ...
    path('edit_household_appliance', views.edit_household_appliance, name="edit_household_appliance"),
    path('delete_household_appliance', views.delete_household_appliance, name="delete_household_appliance"),
