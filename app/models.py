...
class Measure(models.Model):
    ...
    voltage = models.DecimalField(max_digits=4, decimal_places=2, default=0.0)
    current = models.DecimalField(max_digits=4, decimal_places=2, default=0.0)
    active_power = models.DecimalField(max_digits=4, decimal_places=2, default=0.0)
    energy = models.DecimalField(max_digits=4, decimal_places=2, default=0.0)
    frequency = models.DecimalField(max_digits=4, decimal_places=2, default=0.0)
    power_factor = models.DecimalField(max_digits=4, decimal_places=2, default=0.0)
